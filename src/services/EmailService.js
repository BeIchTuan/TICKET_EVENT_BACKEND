          ...
          <div style="background-color: #f8f9fa; padding: 20px; border-radius: 5px; margin: 20px 0;">
            ...
            <div style="background-color: #ffffff; padding: 15px; border-radius: 5px; margin: 15px 0;">
              ...
              <ul style="list-style: none; padding: 0;">
                <li style="margin: 10px 0;"><strong>Mã đặt vé:</strong> ${ticket.bookingCode}</li>
                <li style="margin: 10px 0;"><strong>Sự kiện:</strong> ${event.name}</li>
                <li style="margin: 10px 0;"><strong>Thời gian:</strong> ${eventDate}</li>
                <li style="margin: 10px 0;"><strong>Địa điểm:</strong> ${event.location}</li>
                <li style="margin: 10px 0;"><strong>Giá vé:</strong> ${event.price?.toLocaleString('vi-VN')}đ</li>
              </ul>
            </div>
            ...
            <div style="text-align: center; margin: 20px 0;">
              ...
              <p style="margin-top: 10px; font-size: 12px; color: #666;">Mã booking: ${ticket.bookingCode}</p>
            </div>
